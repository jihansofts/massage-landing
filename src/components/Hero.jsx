      ...
      <div className="container z-100  mx-auto relative h-full flex flex-col justify-start items-start text-left ">
        ...
        <div className="max-w-3xl px-6 mt-10">
          ...
          <div className="flex lg:flex-row md:flex-row flex-col lg:gap-5 md:gap-2 gap-1">
            ...
            <button className="font-helvetica min-w-2xs rounded-4xl font-semibold text-[16px] mt-10 py-4 px-14 border-1 border-white text-white ">
              Our Services
            </button>
          </div>
